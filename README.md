...
## 💕 자기 소개
React·Next.js 프런트엔드로 커리어를 시작해, 지금은 Django 모델·쿼리까지 직접 이어 붙이는 풀스택으로 범위를 넓히고 있는 웹 개발자입니다.  
산업 AI 판독 시스템, 숙박 큐레이션 플랫폼, ITS 표준데이터 관리 시스템 세 도메인을 거치며 국제 표준 문서나 엑셀 기능목록처럼 정형화되지 않은 요구사항을 스키마와 화면으로 옮기는 일을 해 왔습니다.  
2021년 4월에 시작해 재직 합계는 약 4년 반입니다.

## 핵심 역량
- **화면이 사용자에게 사실을 말하게 만듭니다.** [같은 데이터를 두 화면이 198건과 134건으로 세고 있으면](https://hyo814-blog.vercel.app/blog/같은-표준데이터를-두-화면이-198건과-134건으로-세고-있었다) 숫자를 맞추기 전에 "무엇을 그 데이터라고 부르는가"부터 정합니다.
- **개선은 숫자로 확인합니다.** [신청서 항목 모달 후보 조회 20회 → 2회](https://hyo814-blog.vercel.app/blog/신청서-항목-모달에서-후보-조회-20회를-2회로-줄였다), [표준데이터 카드 목록 39 → 19쿼리](https://hyo814-blog.vercel.app/blog/같은-표준데이터를-두-화면이-198건과-134건으로-세고-있었다), [오래 빨갛던 e2e 25건을 갈라 시나리오 274건 실패 0으로](https://hyo814-blog.vercel.app/blog/빨갛게-남아-있던-e2e-25건-중-코드-회귀는-1건이었다).
- **고른 이유와 버린 대안을 같이 남깁니다.** 결정을 뒤집을 때는 날짜와 실측값을 붙여 뒤집었다고 적고, 아직 못 막은 것은 한계로 적습니다.

## ✨ Career Overview

- 보안 기술 기업 G사 [웹 개발] (2025.04 ~ 현재) — ITS 표준데이터 관리 시스템
- 숙박 큐레이션 플랫폼 S사 [프론트엔드] (2022.08 ~ 2024.03)
- 의료 및 산업 AI 솔루션 기업 D사 [프론트엔드] (2021.04 ~ 2022.08)

회사별 상세는 블로그의 [경력기술서 3편](https://hyo814-blog.vercel.app/tags/경력기술서)에 있습니다.
...
- 라이브러리:  
  <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black" alt="React"/> <img src="https://img.shields.io/badge/D3.js-F9A03C?style=flat-square&logo=d3dotjs&logoColor=white" alt="D3.js"/> <img src="https://img.shields.io/badge/jsTree-6E6E6E?style=flat-square" alt="jsTree"/>
...
- 백엔드 프레임워크:<br/>
  <img src="https://img.shields.io/badge/Django-092E20?style=flat-square&logo=django&logoColor=white"/> <img src="https://img.shields.io/badge/Django_REST_Framework-A30000?style=flat-square&logo=django&logoColor=white"/> <img src="https://img.shields.io/badge/Jinja-B41717?style=flat-square&logo=jinja&logoColor=white"/>

- 데이터베이스:<br/>
  <img src="https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white"/> <img src="https://img.shields.io/badge/SQLite-003B57?style=flat-square&logo=sqlite&logoColor=white"/>

- ORM / 데이터 모델링 도구:<br/>
  <img src="https://img.shields.io/badge/Django ORM-092E20?style=flat-square&logo=django&logoColor=white"/> <img src="https://img.shields.io/badge/django--treebeard-092E20?style=flat-square&logo=django&logoColor=white"/>
