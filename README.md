...
프론트엔드 개발에서 웹개발로 확장을 하며 성장을 하고 있습니다.
...
- 보안 위협 대응 생활보안 솔루션을 개발하는 보안 기술 기업 G사 [웹 개발] (2025.04 ~ "")
- 숙박 큐레이터 예약 플랫폼 서비스 개발 S사 [프론트엔드](2022.08 ~ 2024.03)
- 의료와 산업 AI 솔루션을 개발 및 제공하는 인공지능 전문 기업 D사 [프론트엔드](2021.04 ~ 2022.08)
