...
## 💕 자기 소개
사무보조 아르바이트를 하다 개발이 궁금해져 컴퓨터정보공학부로 편입했고, 2021년 4월부터 웹 개발자로 일하고 있습니다.
산업 AI 판독 시스템과 숙박 큐레이션 플랫폼을 거쳐, 지금은 ITS 표준데이터 관리 시스템에서 React 화면부터 Django API·쿼리까지 맡고 있습니다.
표준 문서나 엑셀 기능목록처럼 정리되지 않은 요구사항을 스키마와 화면으로 옮기는 일을 주로 해 왔습니다.
